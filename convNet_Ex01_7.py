...
Description:
	update:
		based on Ex00, added one more leNetPooling layer
...
class ConvNet(object):
	...
	def __init__(self, randomSeed, 
		...
		filter_shape_3, image_shape_3, pool_size_3,
		hiddenLayer_input_d,
		...
		self._layer_conv3 = LeNetConvPoolLayer( randomSeed, self._layer_conv2.output, 
			filter_shape_3, image_shape_3, pool_size_3 )

		self._hidden_input = self._layer_conv3.output.flatten( 2 )
...
instanceEx01 = ConvNet( randomSeed = rSeed, 
		...
		filter_shape_2 = ( 50, 20, 3, 3 ), image_shape_2 = ( 500, 20, 12, 12 ), pool_size_2 = ( 2, 2 ),
		filter_shape_3 = ( 20, 50, 2, 2 ), image_shape_3 = ( 500, 50, 5, 5 ), pool_size_3 = ( 2, 2 ),
		hiddenLayer_input_d = 20*2*2,
...
instanceEx01.writeTrainingLocalMinimum( "convRecord_7.dat" )
